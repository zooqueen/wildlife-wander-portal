    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <div className="container mx-auto px-4 py-4">
          <Link to="/experiences" className="inline-flex items-center text-muted-foreground hover:text-foreground transition-colors">
        ...
        <div className="container mx-auto px-4 mb-8">
          ...
          <div className="flex flex-wrap gap-2 mb-4">
            {experience.wildlifeTypes.map((type) => (
              <Badge key={type} variant="outline" className="bg-accent/50">
                {type}
              </Badge>
            ))}
          </div>
            ...
            <div className="lg:col-span-2">
              <Tabs defaultValue="overview" className="w-full">
                ...
                <TabsContent value="overview" className="mt-6">
                  ...
                  <p className="text-muted-foreground mb-6">{experience.overview}</p>
                  
                  <h3 className="text-lg font-semibold mb-3">Impact</h3>
                  <p className="text-muted-foreground mb-6">{experience.impact}</p>
                ...
                <TabsContent value="ethics" className="mt-6">
                  ...
                  <p className="text-muted-foreground mb-6">{experience.ethicalConsiderations}</p>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-24 bg-white border rounded-lg p-6 shadow-sm">
                <h3 className="text-2xl font-bold mb-2">
                  ${experience.pricing.amount} <span className="text-sm font-normal text-muted-foreground">/ {experience.pricing.period}</span>
                </h3>
                ...
                <div className="space-y-4 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">Flexible, year-round availability</p>
                  </div>
                  
                  <div>
                    <h4 className="font-medium">Group Size</h4>
                    <p className="text-muted-foreground">Maximum 10 volunteers</p>
                  </div>
                </div>
